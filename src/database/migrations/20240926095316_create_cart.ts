...
export async function up(knex: Knex): Promise<void> {
  return knex.schema.createTable(TABLE_NAME, (table) => {
    ...
    table.bigInteger('product_id') // Reference to the product
      .unsigned()
      .notNullable()
      .references('id')
    ...
    table.bigInteger('created_by') // User who created the entry
      .unsigned()
      .notNullable()
      .references('id')
    ...
    table.bigInteger('updated_by') // User who updated the entry
      .unsigned()
      .references('id')
      .inTable('users')
      .nullable();
